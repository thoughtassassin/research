...
public class FeedService {
			...
			@QueryParam("terrorGroup") String terrorGroup)
	{
		...
		try
		{
			ArrayList<TotalGroupAttacks> feedData = null;
			ProjectManager projectManager= new ProjectManager();
			...
			@QueryParam("terrorGroup") String terrorGroup)
	{
		...
		try
		{
			Map<String,Map<String, String>> feedData = null;
			ProjectManager projectManager= new ProjectManager();
			feedData = projectManager.getAllAttacksByYear( yearStart, yearEnd, terrorGroup );
			Gson gson = new Gson();
			//System.out.println(gson.toJson(feedData));
			feeds = gson.toJson(feedData);
			//System.out.println("Are we doing anything?");
